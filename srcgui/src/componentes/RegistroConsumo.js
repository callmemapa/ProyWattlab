    ...
    return (
      <div>
        ...
        <div className="container" style={{marginTop: "30px"}}>
          ...
          <form method="POST" onSubmit={(event) => props.onSubmit(event, consumo)}> 
                <div className="form-group">
                  Número de contrato:
                  <input type="text" value={consumo.numeroContrato} onChange={onChange} required className="form-control"/>        
                </div>
                <div className="form-group">
                  Cantidad KwH:
                  <input type="text" value={consumo.cantidadKwH} onChange={onChange} required className="form-control"/>        
                </div>
